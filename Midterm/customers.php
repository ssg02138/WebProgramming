...
<body>
  <div id="main">
    ...
    <!-- table을 php안에 넣으면 js과 연동이 안됨 -->
    <table border = '1' width='100%' id='insertTable'>
    <tr>
        <th onclick='tablesort(0)'>ID</th>
        <th onclick='tablesort(1)'>NAME</th>
        <th onclick='tablesort(2)'>PRICE</th>
    </tr>
    <?php
